...
const ChatContainer = () => {
    ...
    const { messages, selectedUser, setSelectedUser, sendMessage, getMessages, loadingMessages } = useContext(ChatContext);
    ...
    return loadingMessages ? (<p className="text-center text-gray-400 mt-10">Loading messages...</p>
    ) : (
        selectedUser ? (
